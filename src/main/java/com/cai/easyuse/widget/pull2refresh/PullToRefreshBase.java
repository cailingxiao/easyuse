 ...
 *******************************************************************************/
package com.cai.easyuse.widget.pull2refresh;

import com.cai.easyuse.R;
import com.cai.easyuse.widget.pull2refresh.internal.FlipLoadingLayout;
import com.cai.easyuse.widget.pull2refresh.internal.LoadingLayout;
import com.cai.easyuse.widget.pull2refresh.internal.RotateLoadingLayout;
import com.cai.easyuse.widget.pull2refresh.internal.Utils;
import com.cai.easyuse.widget.pull2refresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    /**
     * @deprecated You should now call this method on the result of {@link #getLoadingLayoutProxy(boolean, boolean)}.
     */
    ...
    protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
        LoadingLayout layout =
                mLoadingAnimationStyle.createLoadingLayout(context, mode, getPullToRefreshScrollDirection(), attrs);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrAnimationStyle)) {
            mLoadingAnimationStyle =
                    AnimationStyle.mapIntToValue(a.getInteger(R.styleable.PullToRefresh_ptrAnimationStyle, 0));
        }
    ...
    public interface OnPullEventListener<V extends View> {
         ...
         *                    direction the user is pulling. Only useful when <var>state</var> is
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mStartTime == -1) {
                ...
                final int deltaY =
                        Math.round(
                                (mScrollFromY - mScrollToY) * mInterpolator.getInterpolation(normalizedTime / 1000f));
