...
public abstract class BasePresenter implements IPresenter {
    ...
    private static final int CORE_POOL_SIZE = Runtime.getRuntime().availableProcessors() * 2 + 5;
    ...
    private static final int MAX_BLOCKING_QUEUE_SIZE = CORE_POOL_SIZE * 2;
    private static final int MAX_BLOCKING_QUEUE_SIZE_DOWNLOAD = 500;
    // 锁，并发处理线程池初始化
     ...
     */
    private CopyOnWriteArrayList<Future> mFrontTasks = new CopyOnWriteArrayList<Future>();
